...
#ifndef _B3_MARKET_DATA_EMPTYBOOK_9_CXX_H_
#define _B3_MARKET_DATA_EMPTYBOOK_9_CXX_H_
...
public:
    ...
    {
        EmptyBook_9 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
