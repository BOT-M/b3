...
#ifndef _B3_MARKET_DATA_EXECUTIONSUMMARY_55_CXX_H_
#define _B3_MARKET_DATA_EXECUTIONSUMMARY_55_CXX_H_
...
public:
    ...
    {
        ExecutionSummary_55 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
