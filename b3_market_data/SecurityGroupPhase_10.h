...
#ifndef _B3_MARKET_DATA_SECURITYGROUPPHASE_10_CXX_H_
#define _B3_MARKET_DATA_SECURITYGROUPPHASE_10_CXX_H_
...
public:
    ...
    {
        SecurityGroupPhase_10 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    SecurityGroupPhase_10 &putSecurityGroup(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    SecurityGroupPhase_10 &putSecurityGroup(T&& src)  SBE_NOEXCEPT requires
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    SecurityGroupPhase_10 &putSecurityGroup(const char (&src)[N]) SBE_NOEXCEPT
    {
