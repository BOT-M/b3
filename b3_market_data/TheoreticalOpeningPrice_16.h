...
#ifndef _B3_MARKET_DATA_THEORETICALOPENINGPRICE_16_CXX_H_
#define _B3_MARKET_DATA_THEORETICALOPENINGPRICE_16_CXX_H_
...
public:
    ...
    {
        TheoreticalOpeningPrice_16 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
