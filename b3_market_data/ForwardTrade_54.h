...
#ifndef _B3_MARKET_DATA_FORWARDTRADE_54_CXX_H_
#define _B3_MARKET_DATA_FORWARDTRADE_54_CXX_H_
...
public:
    ...
    {
        ForwardTrade_54 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
