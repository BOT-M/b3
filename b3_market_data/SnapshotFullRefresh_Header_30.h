...
#ifndef _B3_MARKET_DATA_SNAPSHOTFULLREFRESH_HEADER_30_CXX_H_
#define _B3_MARKET_DATA_SNAPSHOTFULLREFRESH_HEADER_30_CXX_H_
...
public:
    ...
    {
        SnapshotFullRefresh_Header_30 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
