...
#ifndef _B3_MARKET_DATA_SEQUENCE_2_CXX_H_
#define _B3_MARKET_DATA_SEQUENCE_2_CXX_H_
...
public:
    ...
    {
        Sequence_2 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
