...
#ifndef _B3_MARKET_DATA_EXECUTIONSTATISTICS_56_CXX_H_
#define _B3_MARKET_DATA_EXECUTIONSTATISTICS_56_CXX_H_
...
public:
    ...
    {
        ExecutionStatistics_56 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
