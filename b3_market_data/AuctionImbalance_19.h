...
#ifndef _B3_MARKET_DATA_AUCTIONIMBALANCE_19_CXX_H_
#define _B3_MARKET_DATA_AUCTIONIMBALANCE_19_CXX_H_
...
public:
    ...
    {
        AuctionImbalance_19 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
