...
#ifndef _B3_MARKET_DATA_CLOSINGPRICE_17_CXX_H_
#define _B3_MARKET_DATA_CLOSINGPRICE_17_CXX_H_
...
public:
    ...
    {
        ClosingPrice_17 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
