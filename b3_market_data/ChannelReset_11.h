...
#ifndef _B3_MARKET_DATA_CHANNELRESET_11_CXX_H_
#define _B3_MARKET_DATA_CHANNELRESET_11_CXX_H_
...
public:
    ...
    {
        ChannelReset_11 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
