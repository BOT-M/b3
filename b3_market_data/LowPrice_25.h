...
#ifndef _B3_MARKET_DATA_LOWPRICE_25_CXX_H_
#define _B3_MARKET_DATA_LOWPRICE_25_CXX_H_
...
public:
    ...
    {
        LowPrice_25 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
