...
#ifndef _B3_MARKET_DATA_ORDER_MBO_50_CXX_H_
#define _B3_MARKET_DATA_ORDER_MBO_50_CXX_H_
...
public:
    ...
    {
        Order_MBO_50 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
