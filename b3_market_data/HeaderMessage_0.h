...
#ifndef _B3_MARKET_DATA_HEADERMESSAGE_0_CXX_H_
#define _B3_MARKET_DATA_HEADERMESSAGE_0_CXX_H_
...
public:
    ...
    {
        HeaderMessage_0 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
