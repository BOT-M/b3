...
#ifndef _B3_MARKET_DATA_TRADE_53_CXX_H_
#define _B3_MARKET_DATA_TRADE_53_CXX_H_
...
public:
    ...
    {
        Trade_53 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
