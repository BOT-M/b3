...
#ifndef _B3_MARKET_DATA_DELETEORDER_MBO_51_CXX_H_
#define _B3_MARKET_DATA_DELETEORDER_MBO_51_CXX_H_
...
public:
    ...
    {
        DeleteOrder_MBO_51 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
