...
#ifndef _B3_MARKET_DATA_HIGHPRICE_24_CXX_H_
#define _B3_MARKET_DATA_HIGHPRICE_24_CXX_H_
...
public:
    ...
    {
        HighPrice_24 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
