...
#ifndef _B3_MARKET_DATA_SECURITYSTATUS_3_CXX_H_
#define _B3_MARKET_DATA_SECURITYSTATUS_3_CXX_H_
...
public:
    ...
    {
        SecurityStatus_3 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
