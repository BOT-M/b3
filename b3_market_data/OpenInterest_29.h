...
#ifndef _B3_MARKET_DATA_OPENINTEREST_29_CXX_H_
#define _B3_MARKET_DATA_OPENINTEREST_29_CXX_H_
...
public:
    ...
    {
        OpenInterest_29 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
