...
#ifndef _B3_MARKET_DATA_MASSDELETEORDERS_MBO_52_CXX_H_
#define _B3_MARKET_DATA_MASSDELETEORDERS_MBO_52_CXX_H_
...
public:
    ...
    {
        MassDeleteOrders_MBO_52 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
