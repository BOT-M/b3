...
#ifndef _B3_MARKET_DATA_TRADEBUST_57_CXX_H_
#define _B3_MARKET_DATA_TRADEBUST_57_CXX_H_
...
public:
    ...
    {
        TradeBust_57 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
