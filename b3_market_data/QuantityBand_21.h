...
#ifndef _B3_MARKET_DATA_QUANTITYBAND_21_CXX_H_
#define _B3_MARKET_DATA_QUANTITYBAND_21_CXX_H_
...
public:
    ...
    {
        QuantityBand_21 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
