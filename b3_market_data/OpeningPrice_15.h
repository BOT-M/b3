...
#ifndef _B3_MARKET_DATA_OPENINGPRICE_15_CXX_H_
#define _B3_MARKET_DATA_OPENINGPRICE_15_CXX_H_
...
public:
    ...
    {
        OpeningPrice_15 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
