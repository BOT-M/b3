...
#ifndef _B3_MARKET_DATA_SETTLEMENTPRICE_28_CXX_H_
#define _B3_MARKET_DATA_SETTLEMENTPRICE_28_CXX_H_
...
public:
    ...
    {
        SettlementPrice_28 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
