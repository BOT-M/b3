...
#ifndef _B3_MARKET_DATA_LASTTRADEPRICE_27_CXX_H_
#define _B3_MARKET_DATA_LASTTRADEPRICE_27_CXX_H_
...
public:
    ...
    {
        LastTradePrice_27 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
